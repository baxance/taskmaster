...
public final class Team implements Model {
  ...
  private final @ModelField(targetType="TaskTwo") @HasMany(associatedWith = "team", type = TaskTwo.class) List<TaskTwo> teamTasks = null;
  public String getId() {
      return id;
  }
  ...
  public List<TaskTwo> getTeamTasks() {
      return teamTasks;
  }
